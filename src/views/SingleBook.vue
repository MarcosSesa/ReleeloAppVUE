<template>
  <div>
    ...
    <div class="container" style="margin-top: 0;margin-bottom: 0px;margin-left: 0;margin-right: 0;padding-top: 59px;padding-bottom: 60px;background: var(--bs-teal);max-width:100%;">
      <div class="row d-lg-flex d-md-flex d-xxl-flex justify-content-lg-center justify-content-md-center justify-content-xxl-center" style="height: 586px;">
        <div class="col-md-12 text-center" style="background: rgb(255,255,255);border-width: 1px;border-radius: 11px;padding: 9px;max-width: 700px;">
            <img style="width: 100%;height: 400px;" src="https://img.freepik.com/psd-gratis/maqueta-portada-libro_125540-572.jpg?size=626&amp;ext=jpg&amp;ga=GA1.2.1358816262.1641772800" />
            <h1 class="text-start" style="font-family: Abel, sans-serif;">Heading</h1>
            <h1 class="text-start" style="font-size: 15px;font-family: Abel, sans-serif;margin-top: -10px;margin-left: 3px;">Heading</h1>
            <p class="text-start" style="font-family: Abel, sans-serif;margin-top: 19px;">Paragraph</p>
